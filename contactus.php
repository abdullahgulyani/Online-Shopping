...
<form style="position:relative;top:200px;left:650px;" method="POST" action="cont.php">
  <p style="position:relative;top:-60px;left:-15px;color:white;font-size:40px;font-family:Comic Sans MS">CONTACT US</p><br>
  <input type="text" name="Name" placeholder=" Enter Name" style="position:relative;left:-10px;top:-40px;color:black;background-color:#e0ebeb ;width:15%;height:35px;border:none;border-radius:12px;font-family:sans-serif;font-size:20px;">
  <br><br>
 
  <input type="text" name="sub" placeholder=" Subject" style="position:relative;left:-10px;top:-40px;color:black;background-color:#e0ebeb;width:15%;height:35px;border:none;border-radius:12px;font-family:sans-serif;font-size:20px;">
  <br><br>
  
  <input type="text" name="msg" placeholder=" Message" style="position:relative;left:-10px;top:-40px;color:black;background-color:#e0ebeb;width:25%;height:60px;border:none;border-radius:12px;font-family:sans-serif;font-size:20px;">
  <br><br>
  
  <input type="submit" value="Send Message" style="position:relative; left:-10px;top:-50px;color:white;background-color:#00b8e6;width:11%;height:40px;border:none;border-radius:10px;font-family:sans-serif;font-size:22px;opacity:1">
</form> 
